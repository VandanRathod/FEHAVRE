    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Sorry, we couldn't find that product.</p>
        </div>
      </div>
    );
  }
            ...
            <div className="p-8 sm:p-12 lg:p-16 flex-1 flex flex-col justify-center max-w-2xl lg:max-w-none mx-auto lg:mx-0">
              ...
              <div className="space-y-6 mb-12">
                ...
                <div className="flex items-baseline gap-4">
                  <span className="text-5xl sm:text-6xl font-light text-foreground">${product.price.toFixed(2)}</span>
                ...
                <div className="pt-8 border-t border-border">
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div className="space-y-2">
                      ...
                      <div className="text-xs text-muted-foreground font-medium">Free Delivery</div>
                    </div>
                    <div className="space-y-2">
                      <div className="text-2xl">🔒</div>
                      <div className="text-xs text-muted-foreground font-medium">Secure Payment</div>
                    </div>
                    <div className="space-y-2">
                      <div className="text-2xl">↩️</div>
                      <div className="text-xs text-muted-foreground font-medium">Easy Returns</div>
                    </div>
                  </div>
                </div>
              </div>
