...
export function Header({
  ...
  return (
    <header className="backdrop-blur-lg bg-background/80 border-b border-border sticky top-0 z-50 safe-area-top transition-all duration-300">
      <div className="container-responsive flex h-16 xs:h-18 sm:h-20 items-center justify-between">
        {/* Enhanced Logo with better mobile sizing */}
        <Link to="/" className="flex items-center group min-w-touch min-h-touch justify-center">
          <img
            src="/images/bakery/logo/PHOTO-2025-06-23-23-40-29.jpg"
            alt="Havre Bakery Logo"
            className="h-10 w-auto sm:h-12 md:h-14 object-contain rounded-lg bg-white/80 p-1 shadow-sm border border-border/20 transition-all duration-200 group-hover:shadow-md group-hover:bg-white/90"
